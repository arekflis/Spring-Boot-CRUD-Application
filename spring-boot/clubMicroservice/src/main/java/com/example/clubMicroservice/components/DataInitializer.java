...
public class DataInitializer {
    ...
    public void createExemplaryData(){
        ...
        if (clubService.findClubByID(UUID.fromString("786fd273-c231-462f-887b-271c9e7ff27d")).isEmpty()) this.createManUnited();
    ...
    private void createManUnited(){
        Club manchesterUnited = Club.builder()
                .id(UUID.fromString("786fd273-c231-462f-887b-271c9e7ff27d"))
